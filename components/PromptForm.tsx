...
const examplePrompts = [
  {
    ...
    text: 'A futuristic montage visualizing AI systems seamlessly integrating into office environments, classrooms, and university labs to streamline complex tasks and productivity.',
  },
  {
    label: 'Cyberpunk City',
    text: 'A neon-lit cyberpunk city with flying cars, holographic billboards, and bustling streets under a rainy night sky.',
  },
  {
    label: 'Nature Cinematic',
    text: 'A cinematic drone shot sweeping over a majestic waterfall in a lush tropical jungle during golden hour.',
  },
  {
    label: 'Surreal Dream',
    text: 'A surreal dreamscape where clouds are made of cotton candy and islands float in a sky of liquid gold.',
  },
];
          ...
          <div className="mt-4 flex flex-wrap gap-2 justify-center">
            {examplePrompts.map((ex) => (
              <button
                ...
                className="text-xs bg-gray-800 hover:bg-gray-700 border border-gray-600 rounded-full px-3 py-1.5 transition-colors whitespace-nowrap text-gray-300 hover:text-white">
                {ex.label}
              </button>
            ))}
          </div>
